...
public class FormThanhToan extends javax.swing.JFrame {
    ...
    private float tienGioDau = 90000;
    private float tienGioSau = 20000;
    private float tienNgay = 400000;
    private int soNgayKhachO;
    private int soGioKhachO;
    private float tongTienKhachO;
    private float tienDichVu = 0;
    private float tienPhongCoBan = 50000;
    ...
    public void initData() {
        ...
        try {
            ...
            if (listDP2.getMaKieuThue().equals("K001")) {
                ...
                tongTienKhachO += soNgayKhachO * tienNgay;
            ...
            try {
                ...
                if (tenphong.equals("Phòng giường đôi")) {
                    tienPhongCoBan = (float) (tienPhongCoBan * 1.5);
                    lblLoaiPhong.setText(String.valueOf(loaiPhong + "/đôi"));

                } else {
                    lblLoaiPhong.setText(String.valueOf(loaiPhong + "/đơn"));
                ...
                String tongTienFormatted = decimalFormat.format(tienPhongCoBan);
                lblTienPhong.setText(String.valueOf(tongTienFormatted));
            ...
            try {
                List<DichVuDaThue> listDVDT = new ArrayList<>();
                listDVDT = (List<DichVuDaThue>) daoDVDT.findById(madp);
            ...
            float tongTienTT = tongTienKhachO + tienDichVu + tienPhongCoBan;
            String tongTienFormatted = decimalFormat.format(tongTienTT);
    ...
    HoaDonChiTiet getModelHoaDonChiTiet(int i) {
        ...
        model.setPhuThu(tienPhongCoBan);
        return model;
    }
    ...
    public void TinhNgay(String ngayDen, String ngayDi) {
        ...
        try {
            ...
            long diffInMillis = Math.abs(dateDi.getTime() - dateDen.getTime());
    ...
    public void TinhGio(String ngayDen, String ngayDi) {
        ...
        try {
            ...
            // Hiển thị kết quả
            System.out.println("si ngay giua ngay den va ngay di la: " + diffInDays + " ngay.");
    ...
    HoaDonThanhToan getModelHoaDonTT() {
        ...
        String ngayDenString = txtNgayDen.getText();
        String ngayTraString = txtNgayTra.getText();

        SimpleDateFormat dateFormat = new SimpleDateFormat("yyyy-MM-dd");

        try {
            Date ngayDen = dateFormat.parse(ngayDenString);
            Date ngayTra = dateFormat.parse(ngayTraString);

            // Gán ngày đã chuyển đổi vào model
            model.setNgayThue(ngayDen);
            model.setNgayTraD(ngayTra);
            model.setNgayLap(ngayTra);
            // Tiếp tục xử lý hoặc lưu trữ dữ liệu
        } catch (ParseException ex) {
            ex.printStackTrace();
        }
        Tongtien = tongTienKhachO + tienDichVu + tienPhongCoBan;
    ...
    private void initComponents() {
        ...
        lblTienPhong.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        lblTienPhong.setText("Tiền phòng cơ bản");
        ...
        lblKieuThue.setText("Số ngày/giờ khách đã ở");
                ...
                .addGroup(jPanel23Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel23Layout.createSequentialGroup()
                        .addGroup(jPanel23Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addGroup(jPanel23Layout.createSequentialGroup()
                                ...
                                .addGap(18, 18, 18)
                                .addGroup(jPanel23Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(lblTienPhong, javax.swing.GroupLayout.PREFERRED_SIZE, 115, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addGroup(jPanel23Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addGroup(jPanel23Layout.createSequentialGroup()
                        .addGroup(jPanel23Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(jLabel191, javax.swing.GroupLayout.DEFAULT_SIZE, 107, Short.MAX_VALUE))
                        .addGap(7, 7, 7)
                        .addGroup(jPanel23Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
