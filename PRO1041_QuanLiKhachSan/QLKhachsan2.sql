...
create table HoaDonChiTiet(
	...
	Ngaythue datetime,
	PhuThu float,
	constraint fk_hoadon_hoadonchitiet foreign key (MaHD) references HoaDonThanhToan (MaHD)
)
go
...
go
INSERT INTO DichVuDaThue (MaDP, MaDV, TenDV, DonGia) VALUES
(1, 'DV01', N'Dịch vụ Spa', 199000),
(2, 'DV02', N'Dịch vụ trông trẻ', 100000),
(3, 'DV03', N'Dịch vụ cho thuê xe máy tự lái', 60000),
(4, 'DV04', N'Dịch vụ giặt ủi quần áo', 50000),
(5, 'DV05', N'Dịch vụ đưa đón sân bay', 40000),
(6, 'DV06', N'Dịch vụ nhà hàng', 179000),
(7, 'DV07', N'Dịch vụ karaoke', 250000),
(8, 'DV08', N'Dịch vụ cho thuê xe đạp', 35000),
(9, 'DV09', N'Dịch vụ tắm suối', 40000),
(10, 'DV10', N'Yêu cầu dịch vụ ở ngoài', 350000),
(11, 'DV01', N'Dịch vụ Spa', 199000),
(12, 'DV02', N'Dịch vụ trông trẻ', 100000),
(13, 'DV03', N'Dịch vụ cho thuê xe máy tự lái', 60000),
(14, 'DV04', N'Dịch vụ giặt ủi quần áo', 50000),
(15, 'DV05', N'Dịch vụ đưa đón sân bay', 40000),
(16, 'DV06', N'Dịch vụ nhà hàng', 179000),
(17, 'DV07', N'Dịch vụ karaoke', 250000),
(18, 'DV08', N'Dịch vụ cho thuê xe đạp', 35000),
(19, 'DV09', N'Dịch vụ tắm suối', 40000)

delete from DichVuDaThue;
go
